!> Solution for https://adventofcode.com/2022/day/14 part b
module day14b
...
contains
    ...
    function simulate_sand(map) result(sandunits)
        ...
        producing_loop: do
            ...
            ! put sand unit, but overwrite only if exactly at source of sand
            if (x == source_x .and. y == source_y) then
                call map%put(char_sand, x, y, .true.)
                exit producing_loop
            else
